...
# # lets create a board object to represent the mineswpeer game
...
#         # this creates an array lie this:
#         # [[None, None, ..., None],
#         #  [None, None, ..., None],
#         #  [...                  ],
#         #  [None, None, ..., None]]
...
#         # represents how many neighboring bombs there are. We can precompute these and it'll sa
...
#         # dig at location with no neighboring bomsb -> recursively dig neighbors!

#         self.dug.add((row, col)) # keep track that
...
#     #           next to a bomb
#     # Step 4: repeat steps 2 and 3a/b until there are not more places to dig -> VICTORY!
#     safe = True
